...
#### La raison est simple et embêtante : la carte contrôle PERC H200 installé physiquement dans le serveur et trop veille pour les paquets récents du kernel Linux.  
