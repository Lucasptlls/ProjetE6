...
C'est pour cela que dans le document [Installation Proxmox](ProjetE6/Projet système/1.Installation de Proxmox/Installation Proxmox.md) j'ai installé la version 7.4.   
